...
$all_users_sql = "select * from rm_reg";
	...
	$rm_purchase_sql = "insert into rm_purchase(purchase_people, purchase_cat_name, purchase_amount, rm_id, purchase_comments, purchase_time, perhead_amount) values('$people_array', '$purchase_cat_name', '$purchase_amount', '$rm_id', '$purchase_comments', CURDATE(), '$arr')";
