...
<style>
	...
	#purchase_content .row{
		float:left;
		text-align:center;
	}
	#purchase_content .row .col{
		float:left;
		text-align:center;
	}
	.fa-power-off {
			  ...
			  <div class="navbar-fixed">
				<nav>
					<div class="nav-wrapper">
						<a href="#!" class="brand-logo" style="font-size:20px;font-family:lobster;">Room mates<a href="logout.php"><i class="fa fa-power-off"></i></a></a>
