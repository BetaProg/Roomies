...
<body onload="checkit()">
<link rel="preload" href="images/Preloader_2.gif">
...
<!--<head>
	...
	<center>
		<h5 style="font-family:lato;">Hi <b><?php echo $person_name; ?></b> !</h5>
	</center>
	...
	<center>
	<center><h5 style='padding-top:0px;color:#D44433;font-family:Josefin Sans;'>Add Purchase</h5></center>
	<hr style="border-color:black;">
	<h6 style='font-family:Josefin Sans;'>Please don't include :</h6>
	<?php
		...
		while($row_dim = mysql_fetch_array($result_dim_fetch)){
			...
			echo "<a style='font-family:Josefin Sans;'>$dim_names | </a>";
		}
	?>
	</center><br>
		<div id="purchase_main" class="z-depth-3">
			...
			<form action="purchase.php" method="post" validate style="font-family:Josefin Sans;">
					<select class="icons" name="purchase_cat_name" required="true"  id="items" style="font-family:century Gothic;text-align:center;">
						<option disabled selected value style="font-family:lato;text-align:center;width:90%;display:block;margin:5px;">Select the Category</option>
					...
					<div class="input-field col s12">
						<select id="all_participants" required="true" name="purchase_people" multiple>
							...
							<option data-icon="images/sg3.jpg" class="right circle" value="Srinivas">SG</option>
							<option data-icon="images/venreplace.jpg" id="venkat2" class="right circle" value="Venkat">Srinivas2</option>
							<option data-icon="images/psy.jpg" class="right circle" value="Vikram">Vikram</option>
							<option data-icon="images/Vikas.jpg" class="right circle" value="Vikas">Vikas</option>
  ...
  $scope.total_people2 = $window.total_people2;
					...
					<i class="fa fa-inr"></i>
						<input type="number" ng-model="amount" min="0" required="true" data-ng-click="function1('AngularJS')" name="purchase_amount" id="purchase_amount"  />
                                        <label style="margin-left:35%;">Per Head amount is {{ (+amount) / total_people2 }}</label>
					</div>
    ...
    <div id="test2" class="col s12" style="font-family:Josefin Sans;">
		...
		<center><h5 style='padding-top:0px;color:#D44433;font-family:Josefin Sans;'>My Account</h5></center>
		<hr style='border-color:black;'>
...
//});
        ...
        <thead>
		  ...
		  <?php 
			$my_purchase_sql = "select * from rm_purchase where rm_id=$rm_id  and purchase_no>85";
    ...
    <div id="test3" class="col s12" style="height:auto;padding-bottom:20%;margin-bottom:15%;font-family:Josefin Sans;">
	
	<center><h5 style='padding-top:0px;color:#D44433;font-family:Josefin Sans;'>All Purchases</h5></center>
	<hr style="border-color:black;">
		<?php
			include 'profile.php';
		?>
        ...
        <thead>
		  ...
		  <?php
$maid = <<<EOD
<img src='images/maid2.svg' style='width:25px;'></i>
EOD;

$food = <<<EOD
<img src='images/spaguetti.svg' style='width:25px;'></i>
EOD;


$detergent = <<<EOD
<img src='images/washing-machine.svg' style='width:25px;'>
EOD;

$water = <<<EOD
<img src='images/water-bottle.svg' style='width:25px;'>
EOD;

$electricity = <<<EOD
<img src='images/idea.svg' style='width:25px;'>
EOD;

$internet = <<<EOD
<img src='images/wifi.svg' style='width:25px;'>
EOD;

$star = <<<EOD
<img src='images/house.svg' style='width:25px;'>
EOD;
...
?>
		  <?php 
			...
			$all_purchase_sql = "select * from rm_purchase where  purchase_no>85";
...
<div id="bottomit" style="width:100%;height:15%;background-color:transparent;margin-top:100%;"> </div> 
  </body>      
</html>		